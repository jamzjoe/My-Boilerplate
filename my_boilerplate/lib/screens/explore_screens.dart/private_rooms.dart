...
class PrivateRooms extends StatefulWidget {
  const PrivateRooms({super.key});

  @override
  State<PrivateRooms> createState() => _PrivateRoomsState();
}

class _PrivateRoomsState extends State<PrivateRooms> {
  @override
